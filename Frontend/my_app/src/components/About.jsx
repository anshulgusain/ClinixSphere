...
Features
User Authentication: Sign up and log in functionality to manage personal records securely.
...
If you're running MongoDB locally, make sure to start it by using:
